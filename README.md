# Cybersecurity Study: CS50's Introduction to Cybersecurity
...
- These notes are an unofficial derivative work with no affiliation with or endorsement by Harvard or CS50. They are released under the same **[CC BY-NC-SA 4.0](LICENSE)** license.
